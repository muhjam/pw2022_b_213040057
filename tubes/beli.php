...
<div class="col"><h3 id="judul">Product</h3></div>
<div class="col">
	<a href="index.php">home</a> / <a href="index.php#container">shop</a> / <a href="#" class="fw-bold" id="point"><?= $produk['jenis_produk']; ?></a>
</div>
</div>
				...
				<div class="col-md-8 ">
					<div class="card-body">
						...
						<table>
							<tr>
								<td>Warna :</td>
								<td><div class="kotak ms-2" style="background-color:<?= $produk['warna']?>;border:1px solid black;width:20px;height:10px;"></div></td>
							</tr>
						</table>
...
<a href="https://api.whatsapp.com/send?phone=6283124356686&text=Hallo%20saya%20<?= $username;?>.%20Saya%20mau%20memesan%20<?= $produk['jenis_produk']?>%20<?= $produk['nama_produk']?>%20ukuran%20<?= $produk['ukuran']?>,%20dengan%20kode%20barang:<?= $produk['kode_produk']?>." type="button" class="btn btn-outline-success" target="_blank">Lets Buy</a>
