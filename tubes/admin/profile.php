...
<div class="col" >
<a href="profile-edit.php" class="btn btn-dark" style="color:white;text-decoration:none;">Edit</a>
<a href="profile-setting.php" class="btn btn-secondary" style="color:white;text-decoration:none;">Setting</a> <a  href="../logout.php" class="btn btn-danger" style="color:white;text-decoration:none;">Logout</a>
</div>
</div>
