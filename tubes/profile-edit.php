	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="container">
			...
			<form id="bar" action="" method="post" class="d-lg-block" style="display:none;">
				<input id="formm" class="form-control me-lg-2" type="text" placeholder="Cari Produk Goturthings" aria-label="Search"
...
<div class="form-check">
  <input name="gender" class="form-check-input" type="radio" id="flexRadioDefault1" value="male" <?php if($profile['gender']=='male'){echo"checked";}; ?> 
	>
